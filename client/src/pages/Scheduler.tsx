                    ...
                    <form className="space-y-5" onSubmit={handleSchedule}>
                      ...
                      <div>
                          ...
                          {mediaFile ? (
                            ...
                            >
                                <span
                                    className="text-sm text-slate-500 group-hover:text-red-600
                                    transition-colors"
                                >
                          ...
                          <div>
                              ...
                              <div className="relative">
                                  ...
                                  <input
                                      ...
                                      border-slate-200 rounded-lg text-slate-900 text-sm
                                      outline-none"
                                      value={scheduledDate}
                      ...
                      <button
                          ...
                          bg-red-500 hover:bg-red-600 transition-all text-white rounded-lg"
                      >
                          {loading ? (
                              <>
                                  <div
                                      className="size-4 border-2 border-white border-t-transparent
            ...
            <div className="flex-1 flex flex-col gap-6 min-w-0">
                ...
                >
                    ...
                    >
                        ...
                        <span
                            className="ml-auto text-xs font-bold bg-zinc-100 text-zinc-700 px-2 py-0.5 rounded-full"
                        >
                            {scheduled.length}
                        </span>
                    </div>
                              ...
                              >
                                  <div className="flex items-center justify-between mb-2">
                                      ...
                                      <div className="flex items-center gap-2">
                                          {post.mediaType && (
                                              <span
                                                  className="text-xs bg-slate-100 text-slate-600 border border-slate-200 px-1.5 py-0.5 rounded-md font-semibold capitalize"
                                              >
                                                  {post.mediaType}
                                              </span>
                                          )}
